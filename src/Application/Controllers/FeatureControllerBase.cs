...
namespace PromotionEngine.Application.Controllers;

public class FeatureControllerBase : ControllerBase
{
    protected readonly ILogger _logger;
    protected readonly IMediator _mediator;
    public FeatureControllerBase(ILogger logger, IMediator mediator)
    {
        _mediator = mediator;
